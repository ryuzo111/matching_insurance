...
<form action="{{ route('post.create') }}" method="POST">
	...
	<div class="form-check">
        ...
        <input class="form-check-input" type="checkbox" name="interested_insurances[]" value="pension" {{ is_array(old('interested_insurances')) && in_array('pension', old('interested_insurances')) ? 'checked' : ''}}><label class="formcheck-label">年金保険</label>
